...
- 🔧 **Onboarding / Implantação** — Dar **go-live** fazia o cartão sumir do quadro: o treinamento estava concluído, o cliente entregue, e a tela simplesmente esquecia o ticket. Agora o go-live leva os treinamentos para a **etapa final da Implantação**, onde ficam visíveis por **30 dias** com o selo **Go-live DD/MM**. Depois disso saem do quadro do dia a dia — mas basta **pesquisar pelo cliente ou pelo código do ticket** para trazer de volta o go-live de qualquer data.
