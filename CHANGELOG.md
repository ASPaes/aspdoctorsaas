...
- ⬆️ **Onboarding / Dashboard** — O **filtro de período** passa a valer para os prazos. Ele já filtrava treinamentos, paradas e retornos, mas as quatro visões de **SLA** ignoravam a data e mostravam sempre o histórico inteiro. **Treinamento cancelado** também deixa de contar nos percentuais e ganha coluna própria na tabela por tipo, para o número não sumir sem rastro.
