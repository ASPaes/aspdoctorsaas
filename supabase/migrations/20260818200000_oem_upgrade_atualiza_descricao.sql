-- ============================================================================
-- OEM › upgrade: o módulo REAPROVEITADO passa a receber também a descrição do
-- catálogo, igual aos que são criados.
--
-- Antes, só o custo era atualizado e a descrição antiga ficava — na lista de
-- Produtos e módulos os importados ficavam metade com "Importado do OEM ·
-- módulo #N" e metade com o texto velho, sem nada que explicasse a diferença.
-- Quem lê a tela não tem como saber que a diferença era "este já existia".
--
-- Margem e preço de venda continuam intocados: são decisão comercial. O que
-- vem do parceiro é custo e identificação do módulo.
-- ============================================================================
