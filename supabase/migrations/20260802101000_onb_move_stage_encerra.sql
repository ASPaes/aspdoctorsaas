...
-- Regra do owner (01/08): entrar na etapa marcada encerra a contagem da jornada inteira;
-- voltar para uma etapa ANTERIOR reabre (correção de erro de movimentação); avançar mantém.
--
-- Base: md5 a5416a604df6918dcee312f8f022eb04, idêntico em local e produção em 01/08.
-- O resto do corpo é o de hoje, sem alteração.
