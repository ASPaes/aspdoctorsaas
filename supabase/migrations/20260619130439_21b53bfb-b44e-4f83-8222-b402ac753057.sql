...
BEGIN
  ...
  -- Processa primeiro todos os campos não terminais.
  -- Assim, no fluxo “Assumir e encerrar”, o responsável é atualizado antes do status final.
  ...
  -- Status é sempre processado por último para não acionar a trava de ticket encerrado
  -- antes das demais mudanças do mesmo comando.
