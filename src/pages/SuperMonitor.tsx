...
export default function SuperMonitor() {
  ...
  const { tenantMetrics, instances, snapshots, alerts, instanceLog, maintenanceData, refetchMaintenance, todayMetrics, aiCostMetrics, storageMetrics } = useMonitorData({ queryDateFrom, queryDateTo, selectedTenant, refreshKey });
