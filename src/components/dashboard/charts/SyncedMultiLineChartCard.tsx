...
interface SyncedMultiLineChartCardProps {
  title: string;
...
export function SyncedMultiLineChartCard({
  title, data, lines, formatValue = v => v.toLocaleString('pt-BR'),
  tvMode = false, className, height = 300, syncId,
}: SyncedMultiLineChartCardProps) {
      ...
      <CardContent>
        <div style={{ height: chartHeight }}>
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={data} syncId={syncId} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
