...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 z-50 inline-flex h-9 w-9 items-center justify-center rounded-md border border-border bg-background/80 opacity-100 ring-offset-background transition-opacity sm:h-auto sm:w-auto sm:rounded-sm sm:border-0 sm:bg-transparent sm:opacity-70 data-[state=open]:bg-accent data-[state=open]:text-muted-foreground hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none">
