-- ROLLBACK: restaura as definicoes de producao anteriores a 11/09/2026.
DROP FUNCTION IF EXISTS public.fn_cohort_revenue(date, date, integer, bigint, bigint, uuid, text, bigint[], bigint[], bigint[], bigint[], bigint[], text[], bigint[], bigint[], bigint[]);
...
REVOKE ALL ON FUNCTION public.fn_cohort_revenue(date, date, integer, bigint, bigint, uuid, text, bigint[]) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.fn_cohort_revenue(date, date, integer, bigint, bigint, uuid, text, bigint[]) TO authenticated, service_role;

DROP FUNCTION IF EXISTS public.fn_cohort_saldo_forecast(uuid, bigint, bigint, integer, integer[], bigint[], bigint[], bigint[], bigint[], bigint[], text[], bigint[], bigint[], bigint[]);

CREATE OR REPLACE FUNCTION public.fn_cohort_saldo_forecast(p_tenant_id uuid DEFAULT NULL::uuid, p_fornecedor_id bigint DEFAULT NULL::bigint, p_unidade_base_id bigint DEFAULT NULL::bigint, p_janela_meses integer DEFAULT 12, p_horizontes integer[] DEFAULT ARRAY[3, 6, 12], p_fornecedor_ids bigint[] DEFAULT NULL::bigint[])
...
REVOKE ALL ON FUNCTION public.fn_cohort_saldo_forecast(uuid, bigint, bigint, integer, integer[], bigint[]) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.fn_cohort_saldo_forecast(uuid, bigint, bigint, integer, integer[], bigint[]) TO authenticated, service_role;
